        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAttack = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AttacksLeft = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountInfoModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountInfoModel_AspNetUsers_UserId",
                        column: x => x.UserId,
